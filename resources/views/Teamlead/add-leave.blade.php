@include('layout.header')
    @yield('content')
                <form action="{{url('team-lead/post-leave')}}" method="POST" id="tlAddLeaveForm">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Name</label>
                        <input type="text" class="form-control" id="" aria-describedby="emailHelp" value="{{auth('teamlead')->user()->name}}" readonly>
